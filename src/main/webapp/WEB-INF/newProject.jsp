		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-6">
						<section class="panel">
							<header class="panel-heading"> New Project </header>
							<div class="panel-body">
								<form:form role="form" action="/newproject" method="post"
									modelAttribute="newProject">
									<div class="form-group">
										<form:input type="hidden" path="projectCreator" value="${user_id}"/>
										<form:input path="projectName" class="form-control"
											placeholder="Project Name" />
										<form:errors path="projectName" class="text-danger" />
									</div>
									<div class="form-group">
										<form:textarea path="goal" class="form-control"
											placeholder="Goal" />
										<form:errors path="goal" class="text-danger" />
									</div>
									<div class="form-group">
										<form:textarea path="features" class="form-control"
											placeholder="Features" />
										<form:errors path="features" class="text-danger" />
									</div>
									<div class="form-group">
										<form:textarea path="technologies" class="form-control"
