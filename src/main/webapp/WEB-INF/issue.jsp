...
<body>
	...
	<section id="container" class="">
		...
		<header class="header dark-bg">
			...
			<!--logo start-->
			<a href="index.html" class="logo">Pro <span class="lite">Flow</span></a>
			<!--logo end-->
			...
			<div class="top-nav notification-row">
				...
				<ul class="nav pull-right top-menu">
					...
					<li class="dropdown"><a data-toggle="dropdown"
						...
						</span> <span class="username"><c:out value="${user.name}"/></span> <b class="caret"></b>
					</a>
			...
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
							class="icon_document_alt"></i> <span>Projects</span> <span
							class="menu-arrow arrow_carrot-right"></span>
					</a>
						<ul class="sub">
							<li><a class="" href="/newproject">Create a Project</a></li>

						</ul></li>
					<li class="sub-menu"><a href="javascript:;" class=""> <i
							class="icon_desktop"></i> <span>Issues</span> <span
							class="menu-arrow arrow_carrot-right"></span>
					</a>
						<ul class="sub">
							<li><a class="" href="/issues">Report a bug</a></li>
							<li><a class="" href="/issues">Assign user to a bug</a></li>
						</ul></li>
					<li class="sub-menu"><a href="javascript:;" class=""> <i
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-6">
						<section class="panel">
							<header class="panel-heading"> New Issue </header>
							<div class="panel-body">
								<form:form role="form" action="/issues" method="post"
									modelAttribute="newIssue">
									<div class="form-group">
										<form:input type="hidden" path="issueCreator" value="${user_id}"/>
										<form:input path="issueName" class="form-control"
											placeholder="Issue Name" />
										<form:errors path="issueName" class="text-danger" />
									</div>
										<div class="form-group">	
										<form:input path="sprint" class="form-control"
											placeholder="Sprint" />
										<form:errors path="sprint" class="text-danger" />
									</div>
									<div class="form-group">
										<form:select path="assigne" class="form-control"
											placeholder="Assignee" >
											<form:option value="assigne">Select Assignee</form:option>
											<c:forEach items="${users}" var="user" >
												<form:option value="${user.name}"></form:option>
											</c:forEach>
										</form:select>
									...
									<div class="form-group">
										...
										placeholder="Priority" >
											<form:option value="selectpriority">Select Priority</form:option>
									...
									<div class="form-group">
										...
										placeholder="Project" >
											<form:option value="High">Select Project</form:option>
											<c:forEach items="${projects}" var="project" >
												<form:option value="${project.projectName}"></form:option>
											</c:forEach>
										</form:select>
										<form:errors path="project" class="text-danger" />
									</div>
