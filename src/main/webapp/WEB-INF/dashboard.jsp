	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<div class="info-box blue-bg">
							...
							<div class="count"><c:out value="${totalProjects}"/></div>
							<div class="title">Projects In Progress</div>
						</div>
						<!--/.info-box-->
					</div>
					<!--/.col-->
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<div class="info-box brown-bg">
							<i class="fa fa-cubes"></i>
							<div class="count"><c:out value="${totalIssues}"/></div>
							<div class="title">Issues to Resolve</div>
						</div>
						<!--/.info-box-->
					</div>
					<!--/.col-->
					...
					<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<div class="info-box dark-bg">
							...
							<div class="title">Issues Solved</div>
						</div>
						<!--/.info-box-->
					</div>
					<!--/.col-->
				...
				<div class="col-sm-6">
					<section class="panel">
						<header class="panel-heading"> Active Projects </header>
						<table class="table table-striped overflow-auto">
							...
							<tbody>
								<c:forEach items="${projects}" var="project">
									<tr>
										<td><img src="img/right-arrow.png"
											style="height: 18px; margin-top: -2px;"></td>
										<td><a href="viewproject/${project.id}"><c:out value="${project.projectName}" /></a></td>
										<td><c:out value="${project.projectCreator.name}" /></td>
										<td><c:out value="${project.createdAt}" /></td>
										<td>
											<div class="progress thin">
												<a href="/project/delete/${project.id}">Delete |</a> <a href="/editproject/${project.id}">Edit</a>
											</div>
										</td>
									</tr>
								</c:forEach>
...
<!-- ---------------------ACTIVE ISSUE LIST -------------------------------->
						<div class="col-sm-6">
					<section class="panel">
						<header class="panel-heading"> Active Issues </header>
							...
							<tbody>
								<c:forEach items="${issues}" var="issue">
									<tr>
										<td><img src="img/right-arrow.png"
											style="height: 18px; margin-top: -2px;"></td>
										<td><a href="viewissue/${issue.id}"><c:out value="${issue.issueName}" /></a></td>
										<td><c:out value="${issue.project}" /></td>
										<td><c:out value="${issue.priority}" /></td>
										<td><c:out value="${issue.createdAt}" /></td>
										<td>
											<div class="progress thin">
												<a href="issue/delete/${issue.id}">Delete |</a> <a href="/editissue/${issue.id}">Edit</a>
											</div>
										</td>
									</tr>
								</c:forEach>
